...
void inputGetKeys_default_descriptor(void)
{
   ...
   else
   {
      ...
      { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_Y,      "B (C Buttons Mode: C ◀︎ (Left))" },\
      { PAD, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_A,      "(C Buttons Mode: C ▶︎ (Right))" },\
